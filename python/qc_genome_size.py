...
min_genome_cov    = float(sys.argv[4])

genome_size_max      = float(sys.argv[5])
genome_size_min      = float(sys.argv[6])
genome_size_fallback = float(sys.argv[7])
warn_assembly_cov    = float(sys.argv[8])
