...
def main(input_file, output_html, minid_genes):
...
<header>
  <div>
    ...
    <div style="font-size:0.78rem;color:var(--muted);margin-top:4px;font-family:var(--font-main);">Minimum Identity: {minid_genes}% / Minimum Coverage: 90%</div>
  </div>
...
if __name__ == "__main__":
    ...
    minid_genes = int(sys.argv[3]) if len(sys.argv) > 3 else 80
    main(input_file, output_html, minid_genes)
