process polish_contig {
    ...
    bwa-mem2 mem -t ${params.cpus} -K ${params.constants.pol_bwa_K} -Y "\$ASSEMBLY" "\$R1" "\$R2" -B ${params.constants.pol_bwa_B} -L ${params.constants.pol_bwa_L} | \\
    ...
    pilon \\
        ...
        --fix all \\
        --changes \\
        --mindepth ${params.constants.pol_mindepth} \\
        --minmq ${params.constants.pol_minmq} \\
        --minqual ${params.constants.pol_minqual} \\
        --mingap ${params.constants.pol_mingap}
    ...
    python3 ${projectDir}/python/compare_polished.py "\$ASSEMBLY" "${sample_id}_polished.fasta"
