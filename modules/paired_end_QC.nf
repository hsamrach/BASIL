process paired_end_QC {
    ...
    def kmc_cmd = params.genome_size ? "" : """
        ...
        kmc \\
            -k${params.constants.kmer_size} \\
            -t${params.cpus} \\
            -ci${params.constants.kmer_min_count} \\
            @kmc_input.txt \\
            ${sample_id}_kmc \\
    ...
    python3 ${projectDir}/python/qc_genome_size.py ${sample_id} ${genome_size_value} ${params.max_genome_cov} ${params.min_genome_cov} ${params.constants.genome_size_max} ${params.constants.genome_size_min} ${params.constants.genome_size_fallback} ${params.constants.warn_assembly_cov}
