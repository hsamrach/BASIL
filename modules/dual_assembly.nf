process dual_assembly {
    ...
    python3 ${projectDir}/python/parse_qc.py ${qc_summary}
    ...
    python3 ${projectDir}/python/compare_assemblies.py ${sample_id} ${params.min_contig_length} ${params.min_contig_cov} ${params.asm_used}
