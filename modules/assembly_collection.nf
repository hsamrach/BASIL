process format_convert_contigs {
    ...
    output:
    path "converted_contigs/", emit: collected_dir

    script:
    """
    mkdir -p converted_contigs
    
    python3 ${projectDir}/python/convert_fasta_format.py . converted_contigs -v
